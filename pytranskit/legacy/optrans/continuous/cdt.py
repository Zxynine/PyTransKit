...
from pytranskit.legacy.optrans.continuous.base import BaseTransform
from pytranskit.legacy.optrans.utils import check_array, assert_equal_shape, signal_to_pdf
